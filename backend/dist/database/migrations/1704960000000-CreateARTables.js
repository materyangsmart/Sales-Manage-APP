...
exports.CreateARTables1704960000000 = void 0;
const typeorm_1 = require("typeorm");
class CreateARTables1704960000000 {
    async up(queryRunner) {
        ...
        await queryRunner.createIndex('ar_invoices', new typeorm_1.TableIndex({
        ...
        await queryRunner.createIndex('ar_payments', new typeorm_1.TableIndex({
        ...
        await queryRunner.createIndex('ar_apply', new typeorm_1.TableIndex({
...
exports.CreateARTables1704960000000 = CreateARTables1704960000000;
//# sourceMappingURL=1704960000000-CreateARTables.js.map