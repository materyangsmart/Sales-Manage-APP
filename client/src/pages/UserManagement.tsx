...
import { UserPlus, KeyRound, Shield, Trash2, Users, RefreshCw } from "lucide-react";
          ...
          <Dialog open={createOpen} onOpenChange={setCreateOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  填写以下信息创建本地登录账号。创建后用户可使用用户名和密码登录系统。
                </DialogDescription>
              </DialogHeader>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card>
          <CardHeader className="pb-2">
            ...
            <CardTitle className="text-3xl">{userList?.length ?? 0}</CardTitle>
          </CardHeader>
        </Card>
        <Card>
          <CardHeader className="pb-2">
            ...
            <CardTitle className="text-3xl">
              {userList?.filter((u: any) => u.role === "admin").length ?? 0}
            </CardTitle>
          </CardHeader>
        </Card>
        <Card>
          <CardHeader className="pb-2">
            <CardDescription>普通用户</CardDescription>
            <CardTitle className="text-3xl">
              {userList?.filter((u: any) => u.role === "user").length ?? 0}
            </CardTitle>
          </CardHeader>
        </Card>
      </div>
